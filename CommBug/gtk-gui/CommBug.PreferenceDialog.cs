...
namespace CommBug
{
	public partial class PreferenceDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget CommBug.PreferenceDialog
			this.Name = "CommBug.PreferenceDialog";
			...
			// Internal child CommBug.PreferenceDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "PreferenceDialog_VBox";
			w1.BorderWidth = ((uint)(2));
			// Container child PreferenceDialog_VBox.Gtk.Box+BoxChild
			...
			w9.Name = "PreferenceDialog_ActionArea";
			w9.Spacing = 10;
